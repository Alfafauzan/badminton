                            ...
                            <form action="{{ route('articles.store') }}" method="post" enctype="multipart/form-data">
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <input value="{{ old('title') }}" type="text" id="title" name="title"
                                        class="form-control w-50 @error('title') is-invalid @enderror"
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <textarea id="text" name="text" class="form-control w-50  @error('text') is-invalid @enderror" rows="6">{{ old('text') }}</textarea>
                                    @error('text')
                                        <small class="text-danger">{{ $message }}</small>
                                    @enderror
                                </div>
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <input id="author" value="{{ old('author') }}" type="text" name="author"
                                        class="form-control w-50 @error('author') is-invalid @enderror"
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <select name="category_id"
                                        class="form-control w-50 @error('category_id') is-invalid @enderror">
